...
3- Blast_Antibiotic_analysis. Blast result agains ResFinder database
...
7- genome_metadata and PATRIC_genomes_AMR.txt. These files contains the information about pathogenic and clinical relevant bacteria
...
8- Plasmids_groups.txt. In this file we can find the clustering of plasmids depending between which groups do they flow
